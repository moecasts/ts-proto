...
(function(global, factory) { /* global define, require, module */
    ...
    $root.simple = (function() {
        ...
        simple.Simple = (function() {
             ...
             * @property {Array.<Uint8Array>|null} [blobs] Simple blobs
             * @property {google.type.Date|null} [birthday] Simple birthday
             * @property {Uint8Array|null} [blob] Simple blob
             * @property {boolean|null} [enabled] Simple enabled
             */
            ...
            /**
             * Simple blobs.
             * @member {Array.<Uint8Array>} blobs
             * @memberof simple.Simple
             * @instance
             */
            Simple.prototype.blobs = $util.emptyArray;
    
            /**
             * Simple birthday.
             * @member {google.type.Date|null|undefined} birthday
             * @memberof simple.Simple
             * @instance
             */
            Simple.prototype.birthday = null;
             ...
             * @instance
             */
            Simple.prototype.blob = $util.newBuffer([]);
             ...
             * @instance
             */
            Simple.prototype.enabled = false;
            ...
            Simple.encode = function encode(message, writer) {
                ...
                if (message.blobs != null && message.blobs.length)
                    for (var i = 0; i < message.blobs.length; ++i)
                        writer.uint32(/* id 11, wireType 2 =*/90).bytes(message.blobs[i]);
                if (message.birthday != null && Object.hasOwnProperty.call(message, "birthday"))
                    $root.google.type.Date.encode(message.birthday, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
                ...
                if (message.enabled != null && Object.hasOwnProperty.call(message, "enabled"))
                    writer.uint32(/* id 14, wireType 0 =*/112).bool(message.enabled);
                return writer;
            };
            ...
            Simple.verify = function verify(message) {
                ...
                if (message.blobs != null && message.hasOwnProperty("blobs")) {
                    ...
                    for (var i = 0; i < message.blobs.length; ++i)
                        if (!(message.blobs[i] && typeof message.blobs[i].length === "number" || $util.isString(message.blobs[i])))
                            return "blobs: buffer[] expected";
                }
            ...
            Simple.fromObject = function fromObject(object) {
                ...
                if (object.oldStates) {
                    ...
                    for (var i = 0; i < object.oldStates.length; ++i)
                        ...
                        default:
                            if (typeof object.oldStates[i] === "number") {
                                message.oldStates[i] = object.oldStates[i];
                                break;
                            }
                        case "UNKNOWN":
                        case 0:
                ...
                if (object.blobs) {
                    if (!Array.isArray(object.blobs))
                        throw TypeError(".simple.Simple.blobs: array expected");
                    message.blobs = [];
                    for (var i = 0; i < object.blobs.length; ++i)
                        if (typeof object.blobs[i] === "string")
                            $util.base64.decode(object.blobs[i], message.blobs[i] = $util.newBuffer($util.base64.length(object.blobs[i])), 0);
                        else if (object.blobs[i].length >= 0)
                            message.blobs[i] = object.blobs[i];
                }
                if (object.birthday != null) {
                    if (typeof object.birthday !== "object")
                        throw TypeError(".simple.Simple.birthday: object expected");
                    message.birthday = $root.google.type.Date.fromObject(object.birthday);
                }
                if (object.blob != null)
            ...
            Simple.toObject = function toObject(message, options) {
                ...
                if (message.state != null && message.hasOwnProperty("state"))
                    object.state = options.enums === String ? $root.simple.StateEnum[message.state] === undefined ? message.state : $root.simple.StateEnum[message.state] : message.state;
                if (message.grandChildren && message.grandChildren.length) {
                    object.grandChildren = [];
                ...
                if (message.oldStates && message.oldStates.length) {
                    ...
                    for (var j = 0; j < message.oldStates.length; ++j)
                        object.oldStates[j] = options.enums === String ? $root.simple.StateEnum[message.oldStates[j]] === undefined ? message.oldStates[j] : $root.simple.StateEnum[message.oldStates[j]] : message.oldStates[j];
                }
                if (message.createdAt != null && message.hasOwnProperty("createdAt"))
                ...
                if (message.blobs && message.blobs.length) {
                    ...
                    for (var j = 0; j < message.blobs.length; ++j)
                        object.blobs[j] = options.bytes === String ? $util.base64.encode(message.blobs[j], 0, message.blobs[j].length) : options.bytes === Array ? Array.prototype.slice.call(message.blobs[j]) : message.blobs[j];
                }
                if (message.birthday != null && message.hasOwnProperty("birthday"))
                    object.birthday = $root.google.type.Date.toObject(message.birthday, options);
                if (message.blob != null && message.hasOwnProperty("blob"))
            ...
            /**
             * Gets the default type url for Simple
             * @function getTypeUrl
             * @memberof simple.Simple
             * @static
             ...
             */
            Simple.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.Simple";
            };
        ...
        simple.Child = (function() {
            ...
            Child.toObject = function toObject(message, options) {
                ...
                if (message.name != null && message.hasOwnProperty("name"))
                    object.name = message.name;
                if (message.type != null && message.hasOwnProperty("type"))
                    object.type = options.enums === String ? $root.simple.Child.Type[message.type] === undefined ? message.type : $root.simple.Child.Type[message.type] : message.type;
                return object;
            };
            ...
            Child.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.Child";
            };
        ...
        simple.Nested = (function() {
            ...
            Nested.toObject = function toObject(message, options) {
                ...
                if (message.state != null && message.hasOwnProperty("state"))
                    object.state = options.enums === String ? $root.simple.Nested.InnerEnum[message.state] === undefined ? message.state : $root.simple.Nested.InnerEnum[message.state] : message.state;
                return object;
            };
            ...
            Nested.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.Nested";
            };
            ...
            Nested.InnerMessage = (function() {
                ...
                InnerMessage.encode = function encode(message, writer) {
                    ...
                    if (message.name != null && Object.hasOwnProperty.call(message, "name"))
                        writer.uint32(/* id 1, wireType 2 =*/10).string(message.name);
                    if (message.deep != null && Object.hasOwnProperty.call(message, "deep"))
                ...
                /**
                 * Gets the default type url for InnerMessage
                 * @function getTypeUrl
                 * @memberof simple.Nested.InnerMessage
                 * @static
                 * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                 * @returns {string} The default type url
                 */
                InnerMessage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/simple.Nested.InnerMessage";
                };
                ...
                InnerMessage.DeepMessage = (function() {
                    ...
                    /**
                     * Gets the default type url for DeepMessage
                     * @function getTypeUrl
                     * @memberof simple.Nested.InnerMessage.DeepMessage
                     * @static
                     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                     * @returns {string} The default type url
                     */
                    DeepMessage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/simple.Nested.InnerMessage.DeepMessage";
                    };
        ...
        simple.OneOfMessage = (function() {
            ...
            /**
             * OneOfMessage first.
             * @member {string|null|undefined} first
             * @memberof simple.OneOfMessage
             * @instance
             */
            OneOfMessage.prototype.first = null;
    
            /**
             * OneOfMessage last.
             * @member {string|null|undefined} last
             * @memberof simple.OneOfMessage
             * @instance
             */
            OneOfMessage.prototype.last = null;
            ...
            /**
             * Gets the default type url for OneOfMessage
             * @function getTypeUrl
             * @memberof simple.OneOfMessage
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            OneOfMessage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.OneOfMessage";
            };
        ...
        simple.SimpleWithWrappers = (function() {
             ...
             * @property {google.protobuf.BytesValue|null} [id] SimpleWithWrappers id
             */
            ...
            /**
             * SimpleWithWrappers id.
             * @member {google.protobuf.BytesValue|null|undefined} id
             * @memberof simple.SimpleWithWrappers
             * @instance
             */
            SimpleWithWrappers.prototype.id = null;
            ...
            SimpleWithWrappers.encode = function encode(message, writer) {
                ...
                if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                    $root.google.protobuf.BytesValue.encode(message.id, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                return writer;
            };
            ...
            SimpleWithWrappers.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 8: {
                            message.id = $root.google.protobuf.BytesValue.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            SimpleWithWrappers.verify = function verify(message) {
                ...
                if (message.id != null && message.hasOwnProperty("id")) {
                    var error = $root.google.protobuf.BytesValue.verify(message.id);
                    if (error)
                        return "id." + error;
                }
                return null;
            ...
            SimpleWithWrappers.fromObject = function fromObject(object) {
                ...
                if (object.id != null) {
                    if (typeof object.id !== "object")
                        throw TypeError(".simple.SimpleWithWrappers.id: object expected");
                    message.id = $root.google.protobuf.BytesValue.fromObject(object.id);
                }
                return message;
            };
            ...
            SimpleWithWrappers.toObject = function toObject(message, options) {
                ...
                if (message.id != null && message.hasOwnProperty("id"))
                    object.id = $root.google.protobuf.BytesValue.toObject(message.id, options);
                return object;
            };
            ...
            /**
             * Gets the default type url for SimpleWithWrappers
             * @function getTypeUrl
             * @memberof simple.SimpleWithWrappers
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            SimpleWithWrappers.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.SimpleWithWrappers";
            };
        ...
        simple.SimpleWithMap = (function() {
             ...
             * @property {Object.<string,google.protobuf.Timestamp>|null} [mapOfTimestamps] SimpleWithMap mapOfTimestamps
             * @property {Object.<string,Uint8Array>|null} [mapOfBytes] SimpleWithMap mapOfBytes
             * @property {Object.<string,google.protobuf.StringValue>|null} [mapOfStringValues] SimpleWithMap mapOfStringValues
             * @property {Object.<string,number>|null} [longLookup] SimpleWithMap longLookup
             * @property {Object.<string,number>|null} [boolLookup] SimpleWithMap boolLookup
             */
            ...
            /**
             * SimpleWithMap mapOfTimestamps.
             * @member {Object.<string,google.protobuf.Timestamp>} mapOfTimestamps
             * @memberof simple.SimpleWithMap
             * @instance
             */
            SimpleWithMap.prototype.mapOfTimestamps = $util.emptyObject;
    
            /**
             * SimpleWithMap mapOfBytes.
             * @member {Object.<string,Uint8Array>} mapOfBytes
             * @memberof simple.SimpleWithMap
             * @instance
             */
            SimpleWithMap.prototype.mapOfBytes = $util.emptyObject;
    
            /**
             * SimpleWithMap mapOfStringValues.
             * @member {Object.<string,google.protobuf.StringValue>} mapOfStringValues
             * @memberof simple.SimpleWithMap
             * @instance
             */
            SimpleWithMap.prototype.mapOfStringValues = $util.emptyObject;
    
            /**
             * SimpleWithMap longLookup.
             * @member {Object.<string,number>} longLookup
             * @memberof simple.SimpleWithMap
             * @instance
             */
            SimpleWithMap.prototype.longLookup = $util.emptyObject;
    
            /**
             * SimpleWithMap boolLookup.
             * @member {Object.<string,number>} boolLookup
             * @memberof simple.SimpleWithMap
             * @instance
             */
            SimpleWithMap.prototype.boolLookup = $util.emptyObject;
            ...
            SimpleWithMap.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.entitiesById != null && Object.hasOwnProperty.call(message, "entitiesById"))
                ...
                if (message.nameLookup != null && Object.hasOwnProperty.call(message, "nameLookup"))
                ...
                if (message.intLookup != null && Object.hasOwnProperty.call(message, "intLookup"))
                ...
                if (message.mapOfBytes != null && Object.hasOwnProperty.call(message, "mapOfBytes"))
                    for (var keys = Object.keys(message.mapOfBytes), i = 0; i < keys.length; ++i)
                        writer.uint32(/* id 5, wireType 2 =*/42).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]).uint32(/* id 2, wireType 2 =*/18).bytes(message.mapOfBytes[keys[i]]).ldelim();
                if (message.mapOfStringValues != null && Object.hasOwnProperty.call(message, "mapOfStringValues"))
                    for (var keys = Object.keys(message.mapOfStringValues), i = 0; i < keys.length; ++i) {
                        writer.uint32(/* id 6, wireType 2 =*/50).fork().uint32(/* id 1, wireType 2 =*/10).string(keys[i]);
                        $root.google.protobuf.StringValue.encode(message.mapOfStringValues[keys[i]], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim().ldelim();
                    }
                if (message.longLookup != null && Object.hasOwnProperty.call(message, "longLookup"))
                    for (var keys = Object.keys(message.longLookup), i = 0; i < keys.length; ++i)
                        writer.uint32(/* id 7, wireType 2 =*/58).fork().uint32(/* id 1, wireType 0 =*/8).int64(keys[i]).uint32(/* id 2, wireType 0 =*/16).int64(message.longLookup[keys[i]]).ldelim();
                if (message.boolLookup != null && Object.hasOwnProperty.call(message, "boolLookup"))
                    for (var keys = Object.keys(message.boolLookup), i = 0; i < keys.length; ++i)
                        writer.uint32(/* id 8, wireType 2 =*/66).fork().uint32(/* id 1, wireType 0 =*/8).bool(keys[i]).uint32(/* id 2, wireType 0 =*/16).int64(message.boolLookup[keys[i]]).ldelim();
                return writer;
            };
            ...
            SimpleWithMap.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.simple.SimpleWithMap(), key, value;
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            ...
                            message.entitiesById[key] = value;
                            break;
                        }
                    case 2: {
                    ...
                    case 5: {
                            if (message.mapOfBytes === $util.emptyObject)
                                message.mapOfBytes = {};
                            var end2 = reader.uint32() + reader.pos;
                            key = "";
                            value = [];
                    ...
                    case 6: {
                            if (message.mapOfStringValues === $util.emptyObject)
                            ...
                            while (reader.pos < end2) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    value = $root.google.protobuf.StringValue.decode(reader, reader.uint32());
                                    break;
                                default:
                                    reader.skipType(tag2 & 7);
                                    break;
                    ...
                    case 7: {
                            if (message.longLookup === $util.emptyObject)
                                message.longLookup = {};
                            var end2 = reader.uint32() + reader.pos;
                            key = 0;
                            value = 0;
                            ...
                            message.longLookup[typeof key === "object" ? $util.longToHash(key) : key] = value;
                            break;
                        }
                    case 8: {
                            if (message.boolLookup === $util.emptyObject)
                                message.boolLookup = {};
                            var end2 = reader.uint32() + reader.pos;
                            key = false;
                            value = 0;
            ...
            SimpleWithMap.verify = function verify(message) {
                ...
                if (message.mapOfBytes != null && message.hasOwnProperty("mapOfBytes")) {
                    if (!$util.isObject(message.mapOfBytes))
                        return "mapOfBytes: object expected";
                    var key = Object.keys(message.mapOfBytes);
                    for (var i = 0; i < key.length; ++i)
                        if (!(message.mapOfBytes[key[i]] && typeof message.mapOfBytes[key[i]].length === "number" || $util.isString(message.mapOfBytes[key[i]])))
                            return "mapOfBytes: buffer{k:string} expected";
                }
                if (message.mapOfStringValues != null && message.hasOwnProperty("mapOfStringValues")) {
                    if (!$util.isObject(message.mapOfStringValues))
                        return "mapOfStringValues: object expected";
                    var key = Object.keys(message.mapOfStringValues);
                    for (var i = 0; i < key.length; ++i) {
                        var error = $root.google.protobuf.StringValue.verify(message.mapOfStringValues[key[i]]);
                        if (error)
                            return "mapOfStringValues." + error;
                    }
                }
                if (message.longLookup != null && message.hasOwnProperty("longLookup")) {
                    if (!$util.isObject(message.longLookup))
                        return "longLookup: object expected";
                    var key = Object.keys(message.longLookup);
                    for (var i = 0; i < key.length; ++i) {
                        if (!$util.key64Re.test(key[i]))
                            return "longLookup: integer|Long key{k:int64} expected";
                        if (!$util.isInteger(message.longLookup[key[i]]) && !(message.longLookup[key[i]] && $util.isInteger(message.longLookup[key[i]].low) && $util.isInteger(message.longLookup[key[i]].high)))
                            return "longLookup: integer|Long{k:int64} expected";
                    }
                }
                if (message.boolLookup != null && message.hasOwnProperty("boolLookup")) {
                    if (!$util.isObject(message.boolLookup))
                        return "boolLookup: object expected";
                    var key = Object.keys(message.boolLookup);
                    for (var i = 0; i < key.length; ++i) {
                        if (!$util.key2Re.test(key[i]))
                            return "boolLookup: boolean key{k:bool} expected";
                        if (!$util.isInteger(message.boolLookup[key[i]]) && !(message.boolLookup[key[i]] && $util.isInteger(message.boolLookup[key[i]].low) && $util.isInteger(message.boolLookup[key[i]].high)))
                            return "boolLookup: integer|Long{k:bool} expected";
                    }
                }
                return null;
            };
            ...
            SimpleWithMap.fromObject = function fromObject(object) {
                ...
                if (object.mapOfTimestamps) {
                    if (typeof object.mapOfTimestamps !== "object")
                        throw TypeError(".simple.SimpleWithMap.mapOfTimestamps: object expected");
                    message.mapOfTimestamps = {};
                ...
                if (object.mapOfBytes) {
                    if (typeof object.mapOfBytes !== "object")
                        throw TypeError(".simple.SimpleWithMap.mapOfBytes: object expected");
                    message.mapOfBytes = {};
                    for (var keys = Object.keys(object.mapOfBytes), i = 0; i < keys.length; ++i)
                        if (typeof object.mapOfBytes[keys[i]] === "string")
                            $util.base64.decode(object.mapOfBytes[keys[i]], message.mapOfBytes[keys[i]] = $util.newBuffer($util.base64.length(object.mapOfBytes[keys[i]])), 0);
                        else if (object.mapOfBytes[keys[i]].length >= 0)
                            message.mapOfBytes[keys[i]] = object.mapOfBytes[keys[i]];
                }
                if (object.mapOfStringValues) {
                    if (typeof object.mapOfStringValues !== "object")
                        throw TypeError(".simple.SimpleWithMap.mapOfStringValues: object expected");
                    message.mapOfStringValues = {};
                    for (var keys = Object.keys(object.mapOfStringValues), i = 0; i < keys.length; ++i) {
                        if (typeof object.mapOfStringValues[keys[i]] !== "object")
                            throw TypeError(".simple.SimpleWithMap.mapOfStringValues: object expected");
                        message.mapOfStringValues[keys[i]] = $root.google.protobuf.StringValue.fromObject(object.mapOfStringValues[keys[i]]);
                    }
                }
                if (object.longLookup) {
                    if (typeof object.longLookup !== "object")
                        throw TypeError(".simple.SimpleWithMap.longLookup: object expected");
                    message.longLookup = {};
                    for (var keys = Object.keys(object.longLookup), i = 0; i < keys.length; ++i)
                        if ($util.Long)
                            (message.longLookup[keys[i]] = $util.Long.fromValue(object.longLookup[keys[i]])).unsigned = false;
                        else if (typeof object.longLookup[keys[i]] === "string")
                            message.longLookup[keys[i]] = parseInt(object.longLookup[keys[i]], 10);
                        else if (typeof object.longLookup[keys[i]] === "number")
                            message.longLookup[keys[i]] = object.longLookup[keys[i]];
                        else if (typeof object.longLookup[keys[i]] === "object")
                            message.longLookup[keys[i]] = new $util.LongBits(object.longLookup[keys[i]].low >>> 0, object.longLookup[keys[i]].high >>> 0).toNumber();
                }
                if (object.boolLookup) {
                    if (typeof object.boolLookup !== "object")
                        throw TypeError(".simple.SimpleWithMap.boolLookup: object expected");
                    message.boolLookup = {};
                    for (var keys = Object.keys(object.boolLookup), i = 0; i < keys.length; ++i)
                        if ($util.Long)
                            (message.boolLookup[keys[i]] = $util.Long.fromValue(object.boolLookup[keys[i]])).unsigned = false;
                        else if (typeof object.boolLookup[keys[i]] === "string")
                            message.boolLookup[keys[i]] = parseInt(object.boolLookup[keys[i]], 10);
                        else if (typeof object.boolLookup[keys[i]] === "number")
                            message.boolLookup[keys[i]] = object.boolLookup[keys[i]];
                        else if (typeof object.boolLookup[keys[i]] === "object")
                            message.boolLookup[keys[i]] = new $util.LongBits(object.boolLookup[keys[i]].low >>> 0, object.boolLookup[keys[i]].high >>> 0).toNumber();
                }
                return message;
            };
            ...
            SimpleWithMap.toObject = function toObject(message, options) {
                ...
                if (message.mapOfBytes && (keys2 = Object.keys(message.mapOfBytes)).length) {
                    object.mapOfBytes = {};
                    for (var j = 0; j < keys2.length; ++j)
                        object.mapOfBytes[keys2[j]] = options.bytes === String ? $util.base64.encode(message.mapOfBytes[keys2[j]], 0, message.mapOfBytes[keys2[j]].length) : options.bytes === Array ? Array.prototype.slice.call(message.mapOfBytes[keys2[j]]) : message.mapOfBytes[keys2[j]];
                }
                if (message.mapOfStringValues && (keys2 = Object.keys(message.mapOfStringValues)).length) {
                    object.mapOfStringValues = {};
                    for (var j = 0; j < keys2.length; ++j)
                        object.mapOfStringValues[keys2[j]] = $root.google.protobuf.StringValue.toObject(message.mapOfStringValues[keys2[j]], options);
                }
                if (message.longLookup && (keys2 = Object.keys(message.longLookup)).length) {
                    object.longLookup = {};
                    for (var j = 0; j < keys2.length; ++j)
                        if (typeof message.longLookup[keys2[j]] === "number")
                            object.longLookup[keys2[j]] = options.longs === String ? String(message.longLookup[keys2[j]]) : message.longLookup[keys2[j]];
                        else
                            object.longLookup[keys2[j]] = options.longs === String ? $util.Long.prototype.toString.call(message.longLookup[keys2[j]]) : options.longs === Number ? new $util.LongBits(message.longLookup[keys2[j]].low >>> 0, message.longLookup[keys2[j]].high >>> 0).toNumber() : message.longLookup[keys2[j]];
                }
                if (message.boolLookup && (keys2 = Object.keys(message.boolLookup)).length) {
                    object.boolLookup = {};
                    for (var j = 0; j < keys2.length; ++j)
                        if (typeof message.boolLookup[keys2[j]] === "number")
                            object.boolLookup[keys2[j]] = options.longs === String ? String(message.boolLookup[keys2[j]]) : message.boolLookup[keys2[j]];
                        else
                            object.boolLookup[keys2[j]] = options.longs === String ? $util.Long.prototype.toString.call(message.boolLookup[keys2[j]]) : options.longs === Number ? new $util.LongBits(message.boolLookup[keys2[j]].low >>> 0, message.boolLookup[keys2[j]].high >>> 0).toNumber() : message.boolLookup[keys2[j]];
                }
                return object;
            };
            ...
            /**
             * Gets the default type url for SimpleWithMap
             * @function getTypeUrl
             * @memberof simple.SimpleWithMap
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            SimpleWithMap.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.SimpleWithMap";
            };
        ...
        simple.SimpleWithSnakeCaseMap = (function() {
            ...
            SimpleWithSnakeCaseMap.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.simple.SimpleWithSnakeCaseMap(), key, value;
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            /**
             * Gets the default type url for SimpleWithSnakeCaseMap
             * @function getTypeUrl
             * @memberof simple.SimpleWithSnakeCaseMap
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            SimpleWithSnakeCaseMap.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.SimpleWithSnakeCaseMap";
            };
    
            return SimpleWithSnakeCaseMap;
        })();
    
        simple.SimpleWithMapOfEnums = (function() {
    
            /**
             * Properties of a SimpleWithMapOfEnums.
             * @memberof simple
             * @interface ISimpleWithMapOfEnums
             * @property {Object.<string,simple.StateEnum>|null} [enumsById] SimpleWithMapOfEnums enumsById
             */
    
            /**
             * Constructs a new SimpleWithMapOfEnums.
             * @memberof simple
             * @classdesc Represents a SimpleWithMapOfEnums.
             * @implements ISimpleWithMapOfEnums
             * @constructor
             * @param {simple.ISimpleWithMapOfEnums=} [properties] Properties to set
             */
            function SimpleWithMapOfEnums(properties) {
                this.enumsById = {};
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
            ...
            /**
             * SimpleWithMapOfEnums enumsById.
             * @member {Object.<string,simple.StateEnum>} enumsById
             * @memberof simple.SimpleWithMapOfEnums
             * @instance
             */
            SimpleWithMapOfEnums.prototype.enumsById = $util.emptyObject;
    
            /**
             * Creates a new SimpleWithMapOfEnums instance using the specified properties.
             * @function create
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {simple.ISimpleWithMapOfEnums=} [properties] Properties to set
             * @returns {simple.SimpleWithMapOfEnums} SimpleWithMapOfEnums instance
             */
            SimpleWithMapOfEnums.create = function create(properties) {
                return new SimpleWithMapOfEnums(properties);
            };
    
            /**
             * Encodes the specified SimpleWithMapOfEnums message. Does not implicitly {@link simple.SimpleWithMapOfEnums.verify|verify} messages.
             * @function encode
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {simple.SimpleWithMapOfEnums} message SimpleWithMapOfEnums message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            SimpleWithMapOfEnums.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.enumsById != null && Object.hasOwnProperty.call(message, "enumsById"))
                    for (var keys = Object.keys(message.enumsById), i = 0; i < keys.length; ++i)
                        writer.uint32(/* id 1, wireType 2 =*/10).fork().uint32(/* id 1, wireType 0 =*/8).int32(keys[i]).uint32(/* id 2, wireType 0 =*/16).int32(message.enumsById[keys[i]]).ldelim();
                return writer;
            };
    
            /**
             * Encodes the specified SimpleWithMapOfEnums message, length delimited. Does not implicitly {@link simple.SimpleWithMapOfEnums.verify|verify} messages.
             * @function encodeDelimited
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {simple.SimpleWithMapOfEnums} message SimpleWithMapOfEnums message or plain object to encode
             ...
             * @returns {$protobuf.Writer} Writer
             */
            SimpleWithMapOfEnums.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
    
            /**
             * Decodes a SimpleWithMapOfEnums message from the specified reader or buffer.
             * @function decode
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {simple.SimpleWithMapOfEnums} SimpleWithMapOfEnums
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SimpleWithMapOfEnums.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.simple.SimpleWithMapOfEnums(), key, value;
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            if (message.enumsById === $util.emptyObject)
                                message.enumsById = {};
                            var end2 = reader.uint32() + reader.pos;
                            key = 0;
                            value = 0;
            ...
            /**
             * Decodes a SimpleWithMapOfEnums message from the specified reader or buffer, length delimited.
             * @function decodeDelimited
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SimpleWithMapOfEnums.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            /**
             * Verifies a SimpleWithMapOfEnums message.
             * @function verify
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {Object.<string,*>} message Plain object to verify
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            SimpleWithMapOfEnums.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.enumsById != null && message.hasOwnProperty("enumsById")) {
                    if (!$util.isObject(message.enumsById))
                        return "enumsById: object expected";
                    var key = Object.keys(message.enumsById);
                    for (var i = 0; i < key.length; ++i) {
                        if (!$util.key32Re.test(key[i]))
                            return "enumsById: integer key{k:int32} expected";
                        switch (message.enumsById[key[i]]) {
                        default:
                            return "enumsById: enum value{k:int32} expected";
                        case 0:
                        case 2:
                        case 3:
                            break;
            ...
            /**
             * Creates a SimpleWithMapOfEnums message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {simple.SimpleWithMapOfEnums} SimpleWithMapOfEnums
             */
            SimpleWithMapOfEnums.fromObject = function fromObject(object) {
                if (object instanceof $root.simple.SimpleWithMapOfEnums)
                    return object;
                var message = new $root.simple.SimpleWithMapOfEnums();
                if (object.enumsById) {
                    if (typeof object.enumsById !== "object")
                        throw TypeError(".simple.SimpleWithMapOfEnums.enumsById: object expected");
                    message.enumsById = {};
                    for (var keys = Object.keys(object.enumsById), i = 0; i < keys.length; ++i)
                        switch (object.enumsById[keys[i]]) {
                        default:
                            if (typeof object.enumsById[keys[i]] === "number") {
                                message.enumsById[keys[i]] = object.enumsById[keys[i]];
                                break;
                            }
                            break;
                        case "UNKNOWN":
                        case 0:
                            message.enumsById[keys[i]] = 0;
                            break;
                        case "ON":
                        case 2:
                            message.enumsById[keys[i]] = 2;
                            break;
                        case "OFF":
                        case 3:
                            message.enumsById[keys[i]] = 3;
                            break;
                        }
                }
                return message;
            ...
            /**
             * Creates a plain object from a SimpleWithMapOfEnums message. Also converts values to other types if specified.
             * @function toObject
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {simple.SimpleWithMapOfEnums} message SimpleWithMapOfEnums
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            SimpleWithMapOfEnums.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.objects || options.defaults)
                    object.enumsById = {};
                var keys2;
                if (message.enumsById && (keys2 = Object.keys(message.enumsById)).length) {
                    object.enumsById = {};
                    for (var j = 0; j < keys2.length; ++j)
                        object.enumsById[keys2[j]] = options.enums === String ? $root.simple.StateEnum[message.enumsById[keys2[j]]] === undefined ? message.enumsById[keys2[j]] : $root.simple.StateEnum[message.enumsById[keys2[j]]] : message.enumsById[keys2[j]];
                }
                return object;
            };
    
            /**
             * Converts this SimpleWithMapOfEnums to JSON.
             * @function toJSON
             * @memberof simple.SimpleWithMapOfEnums
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            SimpleWithMapOfEnums.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
    
            /**
             * Gets the default type url for SimpleWithMapOfEnums
             * @function getTypeUrl
             * @memberof simple.SimpleWithMapOfEnums
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            SimpleWithMapOfEnums.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.SimpleWithMapOfEnums";
            };
    
            return SimpleWithMapOfEnums;
        })();
        ...
        simple.PingRequest = (function() {
            ...
            PingRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.PingRequest";
            };
        ...
        simple.PingResponse = (function() {
            ...
            PingResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.PingResponse";
            };
        ...
        simple.Numbers = (function() {
            ...
            /**
             * Gets the default type url for Numbers
             * @function getTypeUrl
             * @memberof simple.Numbers
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            Numbers.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.Numbers";
            };
    
            return Numbers;
        })();
    
        simple.SimpleButOptional = (function() {
             ...
             * @property {google.protobuf.Timestamp|null} [createdAt] SimpleButOptional createdAt
             * @property {simple.Child|null} [child] SimpleButOptional child
             * @property {simple.StateEnum|null} [state] SimpleButOptional state
             * @property {simple.ImportedThing|null} [thing] SimpleButOptional thing
             * @property {google.type.Date|null} [birthday] SimpleButOptional birthday
             */
             ...
             * @constructor
             * @param {simple.ISimpleButOptional=} [properties] Properties to set
             */
             ...
             * @memberof simple.SimpleButOptional
             * @instance
             */
            ...
            /**
             * SimpleButOptional createdAt.
             * @member {google.protobuf.Timestamp|null|undefined} createdAt
             * @memberof simple.SimpleButOptional
             * @instance
             */
            SimpleButOptional.prototype.createdAt = null;
    
            /**
             * SimpleButOptional child.
             * @member {simple.Child|null|undefined} child
             * @memberof simple.SimpleButOptional
             * @instance
             */
            SimpleButOptional.prototype.child = null;
    
            /**
             * SimpleButOptional state.
             * @member {simple.StateEnum|null|undefined} state
             * @memberof simple.SimpleButOptional
             * @instance
             */
            SimpleButOptional.prototype.state = null;
    
            /**
             * SimpleButOptional thing.
             * @member {simple.ImportedThing|null|undefined} thing
             * @memberof simple.SimpleButOptional
             * @instance
             */
            SimpleButOptional.prototype.thing = null;
    
            /**
             * SimpleButOptional birthday.
             * @member {google.type.Date|null|undefined} birthday
             * @memberof simple.SimpleButOptional
             * @instance
             */
            SimpleButOptional.prototype.birthday = null;
            ...
            /**
             * SimpleButOptional _createdAt.
             * @member {"createdAt"|undefined} _createdAt
             * @memberof simple.SimpleButOptional
             * @instance
             */
            Object.defineProperty(SimpleButOptional.prototype, "_createdAt", {
                get: $util.oneOfGetter($oneOfFields = ["createdAt"]),
                set: $util.oneOfSetter($oneOfFields)
            });
    
            /**
             * SimpleButOptional _child.
             * @member {"child"|undefined} _child
             * @memberof simple.SimpleButOptional
             * @instance
             */
            Object.defineProperty(SimpleButOptional.prototype, "_child", {
                get: $util.oneOfGetter($oneOfFields = ["child"]),
                set: $util.oneOfSetter($oneOfFields)
            });
    
            /**
             * SimpleButOptional _state.
             * @member {"state"|undefined} _state
             * @memberof simple.SimpleButOptional
             * @instance
             */
            Object.defineProperty(SimpleButOptional.prototype, "_state", {
                get: $util.oneOfGetter($oneOfFields = ["state"]),
                set: $util.oneOfSetter($oneOfFields)
            });
    
            /**
             * SimpleButOptional _thing.
             * @member {"thing"|undefined} _thing
             * @memberof simple.SimpleButOptional
             * @instance
             */
            Object.defineProperty(SimpleButOptional.prototype, "_thing", {
                get: $util.oneOfGetter($oneOfFields = ["thing"]),
                set: $util.oneOfSetter($oneOfFields)
            });
    
            /**
             * SimpleButOptional _birthday.
             * @member {"birthday"|undefined} _birthday
             * @memberof simple.SimpleButOptional
             * @instance
             */
            Object.defineProperty(SimpleButOptional.prototype, "_birthday", {
             ...
             * @static
             * @param {simple.ISimpleButOptional=} [properties] Properties to set
             * @returns {simple.SimpleButOptional} SimpleButOptional instance
             */
            ...
            /**
             * Encodes the specified SimpleButOptional message. Does not implicitly {@link simple.SimpleButOptional.verify|verify} messages.
             * @function encode
             * @memberof simple.SimpleButOptional
             * @static
             * @param {simple.SimpleButOptional} message SimpleButOptional message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified SimpleButOptional message, length delimited. Does not implicitly {@link simple.SimpleButOptional.verify|verify} messages.
             * @function encodeDelimited
             * @memberof simple.SimpleButOptional
             * @static
             * @param {simple.SimpleButOptional} message SimpleButOptional message or plain object to encode
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {simple.SimpleButOptional} SimpleButOptional
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SimpleButOptional.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.simple.SimpleButOptional();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            SimpleButOptional.fromObject = function fromObject(object) {
                if (object instanceof $root.simple.SimpleButOptional)
                    return object;
                var message = new $root.simple.SimpleButOptional();
                if (object.name != null)
                    message.name = String(object.name);
                if (object.age != null)
                    message.age = object.age | 0;
                if (object.createdAt != null) {
                    if (typeof object.createdAt !== "object")
                        throw TypeError(".simple.SimpleButOptional.createdAt: object expected");
                    message.createdAt = $root.google.protobuf.Timestamp.fromObject(object.createdAt);
                }
                if (object.child != null) {
                    if (typeof object.child !== "object")
                        throw TypeError(".simple.SimpleButOptional.child: object expected");
                    message.child = $root.simple.Child.fromObject(object.child);
                }
                switch (object.state) {
                default:
                ...
                if (object.thing != null) {
                    if (typeof object.thing !== "object")
                        throw TypeError(".simple.SimpleButOptional.thing: object expected");
                    message.thing = $root.simple.ImportedThing.fromObject(object.thing);
                }
                if (object.birthday != null) {
                    if (typeof object.birthday !== "object")
                        throw TypeError(".simple.SimpleButOptional.birthday: object expected");
                    message.birthday = $root.google.type.Date.fromObject(object.birthday);
                }
                return message;
            };
             ...
             * @memberof simple.SimpleButOptional
             * @static
             * @param {simple.SimpleButOptional} message SimpleButOptional
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ...
            SimpleButOptional.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.SimpleButOptional";
            };
        ...
        simple.Empty = (function() {
             ...
             * @implements IEmpty
             * @constructor
             * @param {simple.IEmpty=} [properties] Properties to set
             */
             ...
             * @function create
             * @memberof simple.Empty
             * @static
             * @param {simple.IEmpty=} [properties] Properties to set
             * @returns {simple.Empty} Empty instance
             */
            ...
            /**
             * Encodes the specified Empty message. Does not implicitly {@link simple.Empty.verify|verify} messages.
             * @function encode
             * @memberof simple.Empty
             * @static
             * @param {simple.Empty} message Empty message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified Empty message, length delimited. Does not implicitly {@link simple.Empty.verify|verify} messages.
             * @function encodeDelimited
             * @memberof simple.Empty
             * @static
             * @param {simple.Empty} message Empty message or plain object to encode
            ...
            Empty.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.simple.Empty();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    default:
            ...
            Empty.fromObject = function fromObject(object) {
                if (object instanceof $root.simple.Empty)
                    return object;
                return new $root.simple.Empty();
            };
             ...
             * @memberof simple.Empty
             * @static
             * @param {simple.Empty} message Empty
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ...
            Empty.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/simple.Empty";
            };
        ...
        simple.ImportedThing = (function() {
            ...
            /**
             * Gets the default type url for ImportedThing
             * @function getTypeUrl
             * @memberof simple.ImportedThing
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            ImportedThing.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/simple.ImportedThing";
            };
    ...
    $root.google = (function() {
        ...
        google.type = (function() {
            ...
            type.Date = (function() {
                 ...
                 * @memberof google.type.Date
                 * @static
                 * @param {google.type.Date} message Date message or plain object to encode
                 * @param {$protobuf.Writer} [writer] Writer to encode to
                 * @returns {$protobuf.Writer} Writer
                 */
