...
(function(global, factory) { /* global define, require, module */
    ...
    $root.simple = (function() {
        ...
        simple.SimpleWithWrappers = (function() {
             ...
             * @property {google.protobuf.Int64Value|null} [bananas] SimpleWithWrappers bananas
            ...
            /**
             * SimpleWithWrappers bananas.
             * @member {google.protobuf.Int64Value|null|undefined} bananas
             * @memberof simple.SimpleWithWrappers
             * @instance
             */
            SimpleWithWrappers.prototype.bananas = null;
            ...
            SimpleWithWrappers.encode = function encode(message, writer) {
                ...
                if (message.bananas != null && Object.hasOwnProperty.call(message, "bananas"))
                    $root.google.protobuf.Int64Value.encode(message.bananas, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            ...
            SimpleWithWrappers.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4: {
                            message.bananas = $root.google.protobuf.Int64Value.decode(reader, reader.uint32());
                            break;
                        }
                    case 6: {
            ...
            SimpleWithWrappers.verify = function verify(message) {
                ...
                if (message.bananas != null && message.hasOwnProperty("bananas")) {
                    var error = $root.google.protobuf.Int64Value.verify(message.bananas);
                    if (error)
                        return "bananas." + error;
                }
            ...
            SimpleWithWrappers.fromObject = function fromObject(object) {
                ...
                if (object.bananas != null) {
                    if (typeof object.bananas !== "object")
                        throw TypeError(".simple.SimpleWithWrappers.bananas: object expected");
                    message.bananas = $root.google.protobuf.Int64Value.fromObject(object.bananas);
                }
                if (object.coins) {
            ...
            SimpleWithWrappers.toObject = function toObject(message, options) {
                ...
                if (message.bananas != null && message.hasOwnProperty("bananas"))
                    object.bananas = $root.google.protobuf.Int64Value.toObject(message.bananas, options);
                if (message.coins && message.coins.length) {
                    object.coins = [];
        ...
        simple.SimpleWithMap = (function() {
             ...
             * @property {Object.<string,Long>|null} [longLookup] SimpleWithMap longLookup
             */
             ...
             * @member {Object.<string,Long>} longLookup
             * @memberof simple.SimpleWithMap
             * @instance
             */
            ...
            SimpleWithMap.encode = function encode(message, writer) {
                ...
                if (message.longLookup != null && Object.hasOwnProperty.call(message, "longLookup"))
                    for (var keys = Object.keys(message.longLookup), i = 0; i < keys.length; ++i)
                        writer.uint32(/* id 4, wireType 2 =*/34).fork().uint32(/* id 1, wireType 0 =*/8).int64(keys[i]).uint32(/* id 2, wireType 0 =*/16).int64(message.longLookup[keys[i]]).ldelim();
                return writer;
            };
        ...
        simple.Numbers = (function() {
             ...
             * @property {Long|null} [int64] Numbers int64
             * @property {number|null} [uint32] Numbers uint32
             * @property {Long|null} [uint64] Numbers uint64
             * @property {number|null} [sint32] Numbers sint32
             * @property {Long|null} [sint64] Numbers sint64
             * @property {number|null} [fixed32] Numbers fixed32
             * @property {Long|null} [fixed64] Numbers fixed64
             * @property {number|null} [sfixed32] Numbers sfixed32
             * @property {Long|null} [sfixed64] Numbers sfixed64
             * @property {Array.<Long>|null} [manyUint64] Numbers manyUint64
             */
            ...
            /**
             * Numbers manyUint64.
             * @member {Array.<Long>} manyUint64
             * @memberof simple.Numbers
             * @instance
             */
            Numbers.prototype.manyUint64 = $util.emptyArray;
            ...
            Numbers.encode = function encode(message, writer) {
                ...
                if (message.manyUint64 != null && message.manyUint64.length) {
                    writer.uint32(/* id 13, wireType 2 =*/106).fork();
                    for (var i = 0; i < message.manyUint64.length; ++i)
                        writer.uint64(message.manyUint64[i]);
                    writer.ldelim();
                }
                return writer;
            };
            ...
            Numbers.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 13: {
                            if (!(message.manyUint64 && message.manyUint64.length))
                                message.manyUint64 = [];
                            if ((tag & 7) === 2) {
                                var end2 = reader.uint32() + reader.pos;
                                while (reader.pos < end2)
                                    message.manyUint64.push(reader.uint64());
                            } else
                                message.manyUint64.push(reader.uint64());
                            break;
                        }
            ...
            Numbers.verify = function verify(message) {
                ...
                if (message.manyUint64 != null && message.hasOwnProperty("manyUint64")) {
                    if (!Array.isArray(message.manyUint64))
                        return "manyUint64: array expected";
                    for (var i = 0; i < message.manyUint64.length; ++i)
                        if (!$util.isInteger(message.manyUint64[i]) && !(message.manyUint64[i] && $util.isInteger(message.manyUint64[i].low) && $util.isInteger(message.manyUint64[i].high)))
                            return "manyUint64: integer|Long[] expected";
                }
                return null;
            };
            ...
            Numbers.fromObject = function fromObject(object) {
                ...
                if (object.manyUint64) {
                    if (!Array.isArray(object.manyUint64))
                        throw TypeError(".simple.Numbers.manyUint64: array expected");
                    message.manyUint64 = [];
                    for (var i = 0; i < object.manyUint64.length; ++i)
                        if ($util.Long)
                            (message.manyUint64[i] = $util.Long.fromValue(object.manyUint64[i])).unsigned = true;
                        else if (typeof object.manyUint64[i] === "string")
                            message.manyUint64[i] = parseInt(object.manyUint64[i], 10);
                        else if (typeof object.manyUint64[i] === "number")
                            message.manyUint64[i] = object.manyUint64[i];
                        else if (typeof object.manyUint64[i] === "object")
                            message.manyUint64[i] = new $util.LongBits(object.manyUint64[i].low >>> 0, object.manyUint64[i].high >>> 0).toNumber(true);
                }
                return message;
            };
            ...
            Numbers.toObject = function toObject(message, options) {
                ...
                if (message.manyUint64 && message.manyUint64.length) {
                    object.manyUint64 = [];
                    for (var j = 0; j < message.manyUint64.length; ++j)
                        if (typeof message.manyUint64[j] === "number")
                            object.manyUint64[j] = options.longs === String ? String(message.manyUint64[j]) : message.manyUint64[j];
                        else
                            object.manyUint64[j] = options.longs === String ? $util.Long.prototype.toString.call(message.manyUint64[j]) : options.longs === Number ? new $util.LongBits(message.manyUint64[j].low >>> 0, message.manyUint64[j].high >>> 0).toNumber(true) : message.manyUint64[j];
                }
                return object;
            };
